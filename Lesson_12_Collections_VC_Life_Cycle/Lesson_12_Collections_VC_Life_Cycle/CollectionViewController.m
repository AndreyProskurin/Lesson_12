...
//  Lesson_12_Collections_VC_Life_Cycle
//
//  Created by Andrey Proskurin on 19.09.17.
...
- (void)viewDidLoad {
    ...
    for (NSUInteger i = 0; i < 8; i++) {
        ...
        NSDictionary *dictionary = @{@"textKey" : textValue, @"colorKey" : randomColor};
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    // длинная запись через переменные
...
//    label.backgroundColor = color;
    ...
    label.text = [[self.array objectAtIndex:indexPath.row] objectForKey:@"textKey"];
    label.backgroundColor = [[self.array objectAtIndex:indexPath.row] objectForKey:@"colorKey"];
